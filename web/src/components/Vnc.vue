<template>
  <div style="width: 100%; height: 100%; background-color: #000;">
    <iframe id="videoFrame" ref="videoFrame" class="frame" frameBorder="0" v-show="config.mode === 'video'"
            scrolling="no"></iframe>
    <iframe id="vncFrame" ref="vncFrame" class="frame" v-bind:class="{hiddenvnc: config.mode === 'video'}"
            frameBorder="0" v-show="true" scrolling="no"></iframe>
    <a target="_blank" href="/#/upload" style="position: fixed;top: 50%;right: 0">
